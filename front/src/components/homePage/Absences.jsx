        ...
        <div className="flex-1 bg-white p-4 shadow rounded-lg md:w-1/2 h-full">
          ...
          <div className='flex items-center justify-between'>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 ml-6">
              <div className="bg-orange-400 h-2.5 rounded-full" style={{ width: `${(daysAbsented / maxDays) * 100}%` }}></div>
            </div>
          </div>
          <div className="bg-gray-400 h-[0.5px] mb-6" />

          <div className='flex items-center'>
            <h3 className='text-lg font-bold my-4'>Pending Requests: &nbsp;</h3><span className='text-orange-600'>{pendingAbsenceRequests} requests awaiting approval.</span>
          </div>
          {/* Absence Requests */}
